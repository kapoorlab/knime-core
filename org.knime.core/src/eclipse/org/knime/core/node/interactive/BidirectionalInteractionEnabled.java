 ...
 * @since 3.6
 */
public interface BidirectionalInteractionEnabled
    <T extends NodeModel & InteractiveView<T, REP, VAL>,
    REQ extends BidirectionalOperation<T, REP, VAL, RES>,
    RES extends ViewContent,
    REP extends ViewContent,
    VAL extends ViewContent>
