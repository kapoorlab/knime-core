 ...
 * @param <T> The concrete node model class.
 ...
 * @since 3.6
 */
public interface WizardBidirectionalInteractionEnabled
    ...
    /**
     * Processes a view-initialized request. This can be used for
     ...
     * a regular ViewValue object which is also used in unidirectional interactive nodes.
     */
    public RES processViewRequest(REQ request);
