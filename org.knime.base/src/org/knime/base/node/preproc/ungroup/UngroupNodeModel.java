...
public class UngroupNodeModel extends NodeModel {
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
        ...
        final DataTableSpec resultSpec = createUngroupOperation(spec).getDataTableSpec();
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
        ...
        UngroupOperation ugO = createUngroupOperation(table.getDataTableSpec());

        BufferedDataTable[] result =
            new BufferedDataTable[]{ugO.compute(exec, table, getSelectedColIdxs(spec, getColumnNames(spec)), m_trans)};
        return result;
    }

    private UngroupOperation createUngroupOperation(final DataTableSpec spec) throws InvalidSettingsException {
        return new UngroupOperation(spec, m_enableHilite.getBooleanValue(), m_skipMissingVal.getBooleanValue(),
            m_removeCollectionCol.getBooleanValue(), getColumnNames(spec));
    }
    ...
    public StreamableOperator createStreamableOperator(final PartitionInfo partitionInfo,
        ...
        UngroupOperation ugO = createUngroupOperation(spec);
        ...
        return new StreamableOperator() {
            ...
            public void runFinal(final PortInput[] inputs, final PortOutput[] outputs, final ExecutionContext exec)
                ...
                ugO.compute(input, output, exec, -1, idxs, m_trans);
                input.close();
                output.close();
            }
        };
